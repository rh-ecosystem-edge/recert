...
mod tests {
    ...
    fn test_public_key_from_ec_p256_private_key() {
        ...
        match result {
            CryptoObject::PrivateKey(private_key, _) => {
                let public_key = PublicKey::try_from(&private_key).expect("PublicKey::try_from should succeed for EC P-256");
    ...
    fn test_ed25519_public_key_serialize() {
        ...
        assert!(!serialized.is_empty(), "serialized public key should not be empty");
    }
