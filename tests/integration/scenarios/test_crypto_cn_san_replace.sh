...
san_before=$(cert_san_text "${crypto_dir}/server.crt")
...
cn_before=$(cert_subject_cn "${crypto_dir}/server.crt")
assert_eq "$cn_before" "api.old-cluster.example.com" "original cert should have old Subject CN"
...
san_after=$(cert_san_text "${crypto_dir}/server.crt")
...
cn_after=$(cert_subject_cn "${crypto_dir}/server.crt")
assert_eq "$cn_after" "api.new-cluster.example.com" "regenerated cert should have new Subject CN"
